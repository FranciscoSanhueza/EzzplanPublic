...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{ __('Ingreso de Trabajadores') }}</div>
                <div class="card-body">
                <form class="form-group" method="POST" action="{{ route('trabajadores.store') }}">
                        @csrf
                            <div class="form-group row">
                                <label for="run" class="col-md-4 col-form-label text-md-right">Run</label>
                                <div class="col-md-7">
                                    <input type="text" class="form-control @error('run') is-invalid @enderror" id="run" name="run" value="{{ old('run') }}" required >
                                    @error('run')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control @error('cargo') is-invalid @enderror" id="cargo" name="cargo" required>
...
@component('layouts.toast')
    ...
    @slot('body' , 'Trabajador Ingresado correctamente' ) 
@endcomponent
@endisset
@endsection